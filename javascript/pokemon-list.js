...
function renderPokemonListItem(index) {
    if (currentList[index]) {
        document.getElementById('Pokecard-list-render-container').insertAdjacentHTML('beforeend', `<div onclick="openInfo(${currentList[index].id})" class="pokemon-render-result-container container center column">
...
function search() {
    setTimeout(function () {
        ...
        document.getElementById('Pokecard-list-render-container').innerHTML = '';
